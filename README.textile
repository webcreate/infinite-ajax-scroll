...
h3. scrollInContainer

*Default:* false
Set this to true to listen scroll events from the container.
This option is useful when you have a container with a small height which can be scroll.
