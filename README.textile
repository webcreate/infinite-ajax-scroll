...
Event handler. Is called each time while new items are being loaded.

Enables you to do fancy loader stuff. Per default, the loader will be inserted right after the last item.

bc. onRenderComplete: function(loader) { console.log(loader); } 
